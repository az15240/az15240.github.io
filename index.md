...
- I am a second year undergraduate student in Computer Science at the University of Washington. I am currently in [Gilbert Bernstein](https://gilbertbernstein.com/)'s group but I'm not doing research with him. I'm also a student in the [PLSE](https://uwplse.org/) group. 
...
- **[Mar. 2023]** I became a TA in [CSE 341 Programming Languages](https://cse.uw.edu/341). 
...
**[Primitive Tagging for Everyday Objects Research](https://github.com/merlinyx/primtag)**
...
- I am a current teaching assistant in [CSE 341 & 413 Programming Languages](https://cse.uw.edu/341), for 4 consecutive quarters. The course is mainly functional programming that taught language design and interpreter construction, using OCaml. Other instructors have been using languages including Racket, Scheme and Ruby. 

- I am the owner of the "[StanleyYang Talking about Math Video](https://weixin.qq.com/r/lx1cWa3EPmVCKOk6b0gT)" channel on WeChat. I created and posted math tutorial videos on a biweekly basis. I supported the math studies of over 350 students, in 26 videos. 

- I was a tutor for The Sailors, a student-run tutor group. I taught 7 students with varying academic backgrounds and needs. I taught math, physics, and computer science. 
...
## Volunteering 
- I volunteered in the [2023 ACM SIGMOD/PODS Conference](https://2023.sigmod.org/), helped with six research and tutorial sessions, supported session chairs and presenters in preparing session slides and videos, aiding conference proceedings.
- I joined [FIUTS (Foundation for International Understanding Through Students)](https://www.fiuts.org/) as an event facilitator, volunteering for international students.
- I joined [CIRCLE (Center for International Relations & Cultural Leadership Exchange)](https://www.washington.edu/circle/) as a CIRCLE Ambassador, volunteering for international students.
- I joined the Ice Cream Summer Camp as a camp leader, leading a diverse group of kids, spanning different age groups, to enjoy the great outdoors and explore scientific gadgets.
...
- I applied for Oxford, but I got rejected. Maybe I messed up with my interview but I was feeling ok for it. There are a MAT (Maths Admissions Test) and I got surprisingly good on it, getting a 97 out of 100 which ranks top 1% among 2816 competitors. I felt so close to Oxford but what a pity...
